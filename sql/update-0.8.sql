...
insert into CmdbAccessRules (accessgroup, applicationpart, access)  VALUES('admin', 'admin', 2);
insert into CmdbAccessRules (accessgroup, applicationpart, access)  VALUES('admin', 'rest', 2);
